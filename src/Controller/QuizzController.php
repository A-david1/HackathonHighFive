...
class QuizzController extends AbstractController
{
     ...
     */
    public function quizz(QuestionRepository $questionRepository,
    ...
    {
        $statQuestion1Choice1 = count($answerRepository->findBy(['question' => 1, 'answer' => 'The human side']));
        $statQuestion1Choice2 = count($answerRepository->findBy(['question' => 1, 'answer' => 'Specifications']));
        $statQuestion1Choice3 = count($answerRepository->findBy(['question' => 1, 'answer' => 'Technologies']));
        $statQuestion1Choice4 = count($answerRepository->findBy(['question' => 1, 'answer' => 'The paycheck']));
        ...
        $statQuestion2Choice1 = count($answerRepository->findBy(['question' => 2, 'answer' => 'Yes']));
        $statQuestion2Choice2 = count($answerRepository->findBy(['question' => 2, 'answer' => 'No']));
        $statQuestion2Choice3 = count($answerRepository->findBy(['question' => 2, 'answer' => 'Maybe']));
        $statQuestion2Choice4 = count($answerRepository->findBy(['question' => 2, 'answer' => 'Why not ?']));
        ...
        $statQuestion3Choice1 = count($answerRepository->findBy(['question' => 3, 'answer' => 'Persistent']));
        $statQuestion3Choice2 = count($answerRepository->findBy(['question' => 3, 'answer' => 'Organized']));
        $statQuestion3Choice3 = count($answerRepository->findBy(['question' => 3, 'answer' => 'Creative']));
        $statQuestion3Choice4 = count($answerRepository->findBy(['question' => 3, 'answer' => 'Pragmatic']));
        ...
        $statQuestion4Choice1 = count($answerRepository->findBy(['question' => 4, 'answer' => 'Linkedin']));
        $statQuestion4Choice2 = count($answerRepository->findBy(['question' => 4, 'answer' => 'Facebook']));
        $statQuestion4Choice3 = count($answerRepository->findBy(['question' => 4, 'answer' => 'Instagram']));
        $statQuestion4Choice4 = count($answerRepository->findBy(['question' => 4, 'answer' => 'Twitter']));
        ...
        $statQuestion5Choice1 = count($answerRepository->findBy(['question' => 5, 'answer' => 'Windows']));
        $statQuestion5Choice2 = count($answerRepository->findBy(['question' => 5, 'answer' => 'Linux']));
        $statQuestion5Choice3 = count($answerRepository->findBy(['question' => 5, 'answer' => 'Mac OS']));
        $statQuestion5Choice4 = count($answerRepository->findBy(['question' => 5, 'answer' => 'Paper and pencil']));
        ...
        $statQuestion6Choice1 = count($answerRepository->findBy(['question' => 6, 'answer' => 'Half empty']));
        $statQuestion6Choice2 = count($answerRepository->findBy(['question' => 6, 'answer' => 'Half full']));
        $statQuestion6Choice3 = count($answerRepository->findBy(['question' => 6, 'answer' => '']));
        $statQuestion6Choice4 = count($answerRepository->findBy(['question' => 6, 'answer' => '']));
        ...
        $statQuestion7Choice1 = count($answerRepository->findBy(['question' => 7, 'answer' => 'K2000']));
        $statQuestion7Choice2 = count($answerRepository->findBy(['question' => 7, 'answer' => 'Dolorean']));
        $statQuestion7Choice3 = count($answerRepository->findBy(['question' => 7, 'answer' => '']));
        $statQuestion7Choice4 = count($answerRepository->findBy(['question' => 7, 'answer' => '']));
        ...
        $statQuestion8Choice1 = count($answerRepository->findBy(['question' => 8, 'answer' => 'Nomad']));
        $statQuestion8Choice2 = count($answerRepository->findBy(['question' => 8, 'answer' => 'Sedentary']));
        $statQuestion8Choice3 = count($answerRepository->findBy(['question' => 8, 'answer' => '']));
        $statQuestion8Choice4 = count($answerRepository->findBy(['question' => 8, 'answer' => '']));
        ...
        $statQuestion9Choice1 = count($answerRepository->findBy(['question' => 9, 'answer' => 'A duck']));
        $statQuestion9Choice2 = count($answerRepository->findBy(['question' => 9, 'answer' => 'A rabbit']));
        $statQuestion9Choice3 = count($answerRepository->findBy(['question' => 9, 'answer' => '']));
        $statQuestion9Choice4 = count($answerRepository->findBy(['question' => 9, 'answer' => '']));
        ...
        $statQuestion10Choice1 = count($answerRepository->findBy(['question' => 10, 'answer' => 'Day worker']));
        $statQuestion10Choice2 = count($answerRepository->findBy(['question' => 10, 'answer' => 'Night worker']));
        $statQuestion10Choice3 = count($answerRepository->findBy(['question' => 10, 'answer' => '']));
        $statQuestion10Choice4 = count($answerRepository->findBy(['question' => 10, 'answer' => '']));
     ...
     */
    public function results(Answer $answer, UserRepository $userRepository, AnswerRepository $answerRepository)
    {
        $answerUser = $answerRepository->findBy(['user' => 5]);

        $answer->getUser()->getAnswers();
